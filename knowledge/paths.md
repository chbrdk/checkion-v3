...
- Field smart suggestions (Market SEO): `POST /api/projects/:id/seo/competitors/suggest` · OpenRouter `qwen/qwen3.7-flash` (`CHECKION_SEO_FIELD_SUGGEST_MODEL`) · same `OPENROUTER_API_KEY` · spec `seo-project-workspace.md`
