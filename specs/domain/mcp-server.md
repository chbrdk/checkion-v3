...
| Domain crawls | `domain_scans_list`, `domain_scan_start`, `domain_scan_get`, `domain_scan_overview`, `domain_scan_issues`, `domain_scan_control`, `domain_scan_seo_reading`, `domain_scan_trust_reading`, `project_active_domain_scans` |
