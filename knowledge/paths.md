...
`GET /api/platform/provisioning/projects/{id}` — Plexon / METRON Collection dashboard BFF: catalogs + `latestCompletedScan` distillate + `scoreHistory` (Wave B) for METRON suite sync.
